...
execute if score dCountS VariablesI matches 6 as @e[type=area_effect_cloud,name="dscout_sc"] at @s unless block ~ ~-1 ~ #strangecurse:nonsolid run scoreboard players set @e[type=area_effect_cloud,name="dscout_sc"] VariablesI 6
