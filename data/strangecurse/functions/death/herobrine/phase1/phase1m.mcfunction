...
execute as @e[type=armor_stand,name="herobrine"] at @s if entity @p[tag=herobrinemarked,distance=...5] run function strangecurse:death/herobrine/phase4/killplayer
