...
## Add Health
execute if score countM VariablesI matches 1 run effect give @s health_boost 1180 0 true
execute if score countM VariablesI matches 2 run effect give @s health_boost 1180 1 true
execute if score countM VariablesI matches 3 run effect give @s health_boost 1180 2 true
execute if score countM VariablesI matches 4 run effect give @s health_boost 1180 3 true
execute if score countM VariablesI matches 5 run effect give @s health_boost 1180 4 true
execute if score countM VariablesI matches 6 run effect give @s health_boost 1180 5 true
execute if score countM VariablesI matches 7 run effect give @s health_boost 1180 6 true
execute if score countM VariablesI matches 8 run effect give @s health_boost 1180 7 true
execute if score countM VariablesI matches 9 run effect give @s health_boost 1180 8 true
execute if score countM VariablesI matches 10 run effect give @s health_boost 1180 9 true
